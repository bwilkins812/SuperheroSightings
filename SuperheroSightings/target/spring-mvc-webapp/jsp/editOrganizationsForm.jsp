<%-- 
    Document   : editOrganizationsForm
    Created on : Jul 22, 2018, 4:56:28 PM
    Author     : brettwilkins
--%>
...
<html>
    ...
    <body style = "background-color: #f0f0e8">
        <div class="container">
            <h1 style = "color: darkred">Edit Organization</h1>
            <hr/>
            <div class="navbar">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <sf:input type="text" class="form-control" id="add-org-description"
                                  path="orgDescription" placeholder="Organization Description"/>
