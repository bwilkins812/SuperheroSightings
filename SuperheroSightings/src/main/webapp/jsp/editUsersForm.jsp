<%-- 
    Document   : editUsers
    Created on : Aug 12, 2018, 8:11:19 AM
    Author     : brettwilkins
--%>
...
<html>
    ...
    <body style = "background-color: #f0f0e8">
        <div class="container">
            <h1 style = "color: darkred">Edit User</h1>
            <hr/>
            <div class="navbar">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="user"
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="add-user-name"
                                  path="userName" placeholder="User Name"/>
                        <sf:errors path="userName" cssclass="error"></sf:errors>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-password" class="col-md-4 control-label">Enter a new password:</label>
                        <div class="col-md-8">
                        <sf:input type="password" class="form-control" id="add-password"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">                           
                        <sf:checkbox path="authorities" value="ROLE_USER"/> Yes                   
            ...
            <div class="form-group">
                <div class="col-md-offset-4 col-md-8">
                    <input type="submit" class="btn btn-default" value="Update User Info"/>
                </div>
            </div>
        </sf:form>                
    </div>
